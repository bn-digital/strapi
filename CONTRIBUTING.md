...
Strapi is an open-source project administered by [BN Digital engineering team](https://bndigital.co). We appreciate your interest and efforts to contribute to Strapi. See the [LICENSE](https://github.com/bn-digital/strapi/blob/latest/LICENSE) licensing information. All work done is available on GitHub.
